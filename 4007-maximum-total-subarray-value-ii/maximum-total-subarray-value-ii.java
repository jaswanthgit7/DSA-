class Solution {
    static class Sparse {
        ...
        long getMin(int l, int r) { int k = log[r - l + 1]; return Math.min(mn[k][l], mn[k][r - (1 << k) + 1]); }
        long getMax(int l, int r) { int k = log[r - l + 1]; return Math.max(mx[k][l], mx[k][r - (1 << k) + 1]); }
    }
